...
[**MVC模式**](http://www.runoob.com/design-pattern/mvc-pattern.html)

MVC 模式（MVC Pattern）：代表 Model-View-Controller（模型-视图-控制器） 模式。这种模式用于应用程序的分层开发。
...
[**拦截过滤器模式**](http://www.runoob.com/design-pattern/intercepting-filter-pattern.html)
...
[**服务定位器模式**](http://www.runoob.com/design-pattern/service-locator-pattern.html)
...
[**传输对象模式**](http://www.runoob.com/design-pattern/transfer-object-pattern.html)
